            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Create Category <small>different form elements</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                @endif
                                    {!! Form::open(['method'=>'POST','id'=>'demo-form2', 'action'=>'AdminCategoryController@store','files'=>true, 'class'=>'form-horizontal form-label-left' ]) !!}
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 mt-2">
                                            Active:
                                            <input type="radio" class="flat" name="enable" id="active" value="1" checked/>
                                            Not Active:
                                            <input type="radio" class="flat" name="enable" id="notActive" value="0"/>
