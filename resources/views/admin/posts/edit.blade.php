                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        ...
                        @if(Auth::check())
                            <div class="x_content">
                                <br />
                                    {!! Form::model($post, ['method'=>'PATCH','id'=>'demo-form2', 'action'=>['AdminPostController@update', $post->id],'files'=>true, 'class'=>'form-horizontal form-label-left' ]) !!}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 ">
                                        ...
                                        <input type="text" id="first-name" name="title" required="required" class="form-control" value="{{$post->title}}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        Not Active:
                                        <input type="radio" class="flat" name="status" id="notActive" value="0" checked="" />
