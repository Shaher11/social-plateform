                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                @endif
                                    {!! Form::open(['method'=>'PUT','id'=>'demo-form2', 'action'=>['AdminTagController@update', $tag],'files'=>true, 'class'=>'form-horizontal form-label-left' ]) !!}
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-8 col-sm-8 ">
                                            <input type="text" id="first-name" name="name" required="required" class="form-control " value="{{$tag->name}}">
                                        </div>
                                    </div>
